                                        ...
                                        <tbody>
                                            <c:forEach items="${reviews}" var="review">
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        <button class="btn-icon view" title="View Review">V</button>
                                                        <button class="btn-icon edit" title="Edit Review">E</button>
                                                        <form action="${pageContext.request.contextPath}/admin/reviews"
                                                            ...
                                                            <button type="submit" class="btn-icon delete"
                                                                title="Delete Review"
                                                                onclick="return confirm('Are you sure you want to delete this review?')">D</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </c:forEach>
